...
// ... existing code ...
    ...
    ASSESSMENT_PARTICIPATION_STATUS_INVALID(8031, "参与状态参数不正确", HttpStatus.BAD_REQUEST),
    ASSESSMENT_REMINDER_NOT_ALLOWED(8032, "当前考核状态不允许发送提醒", HttpStatus.CONFLICT),
    ASSESSMENT_REMINDER_RATE_LIMITED(8033, "操作过于频繁，请稍后再试", HttpStatus.TOO_MANY_REQUESTS),
    ASSESSMENT_REMINDER_SEND_FAILED(8034, "提醒发送失败", HttpStatus.INTERNAL_SERVER_ERROR),
    ASSESSMENT_REMINDER_USER_IDS_REQUIRED(8035, "提醒人员列表不能为空", HttpStatus.BAD_REQUEST),
    ASSESSMENT_REMINDER_USER_IDS_TOO_MANY(8036, "单次提醒人数不能超过100人", HttpStatus.BAD_REQUEST),
    ASSESSMENT_REMINDER_USER_IDS_DUPLICATE(8037, "提醒人员列表不能重复", HttpStatus.BAD_REQUEST),
