...
CREATE TABLE `category` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_deleted_at` (`deleted_at`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='培训分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course` (
  ...
  `instructor_id` mediumtext COMMENT '讲师id',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程章节表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `course_stat_snapshot`
--

DROP TABLE IF EXISTS `course_stat_snapshot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `course_stat_snapshot` (
  `stat_date` date NOT NULL COMMENT '统计日期',
  `total_courses` bigint NOT NULL DEFAULT '0' COMMENT '当日结束时未删除课程总数',
  `draft_courses` bigint NOT NULL DEFAULT '0' COMMENT '当日结束时草稿课程数',
  `published_courses` bigint NOT NULL DEFAULT '0' COMMENT '当日结束时已发布课程数',
  `offline_courses` bigint NOT NULL DEFAULT '0' COMMENT '当日结束时已下架课程数',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`stat_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程管理统计快照';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='培训PPT表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_course_point_progress`
--

DROP TABLE IF EXISTS `user_course_point_progress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_course_point_progress` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint NOT NULL COMMENT '学员ID',
  `course_id` bigint NOT NULL COMMENT '课程ID',
  `course_point_id` bigint NOT NULL COMMENT '课程点ID',
  `required` tinyint NOT NULL DEFAULT '1' COMMENT '是否必修：0-选修，1-必修，冗余课程点当时配置',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态：0-未开始，1-学习中，2-已完成',
  `started_at` datetime DEFAULT NULL COMMENT '开始学习时间',
  `completed_at` datetime DEFAULT NULL COMMENT '完成课程点时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_point` (`user_id`,`course_point_id`),
  KEY `idx_user_course` (`user_id`,`course_id`),
  KEY `idx_course_point` (`course_point_id`),
  KEY `idx_course_status` (`course_id`,`status`),
  CONSTRAINT `fk_ucpp_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `fk_ucpp_point` FOREIGN KEY (`course_point_id`) REFERENCES `course_point` (`id`),
  CONSTRAINT `fk_ucpp_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学员课程点学习进度表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_course_progress` (
  ...
  `user_id` bigint NOT NULL COMMENT '学员ID',
  `course_id` bigint NOT NULL COMMENT '课程ID',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '学习状态：0-未开始，1-学习中，2-已完成',
  `progress_percent` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '课程整体进度百分比',
  `last_point_id` bigint DEFAULT NULL COMMENT '最近学习的课程点ID',
  `started_at` datetime DEFAULT NULL COMMENT '开始学习时间',
  `completed_at` datetime DEFAULT NULL COMMENT '完成课程时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  ...
  KEY `idx_last_point_id` (`last_point_id`),
  CONSTRAINT `fk_ucp_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `fk_ucp_last_point` FOREIGN KEY (`last_point_id`) REFERENCES `course_point` (`id`),
  CONSTRAINT `fk_ucp_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学员课程学习进度表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `user_course_resource_progress`
--

DROP TABLE IF EXISTS `user_course_resource_progress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_course_resource_progress` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint NOT NULL COMMENT '学员ID',
  `course_id` bigint NOT NULL COMMENT '课程ID',
  `course_point_id` bigint NOT NULL COMMENT '课程点ID',
  `resource_type` tinyint NOT NULL COMMENT '课件类型：1-文章，2-视频，3-PPT',
  `resource_id` bigint NOT NULL COMMENT '课件ID',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态：0-未开始，1-学习中，2-已完成',
  `progress_percent` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '课件进度百分比',
  `last_position_seconds` int DEFAULT NULL COMMENT '最近停留位置，主要用于视频续播',
  `max_position_seconds` int DEFAULT NULL COMMENT '历史最远播放位置，主要用于视频完成判断',
  `duration_seconds` int DEFAULT NULL COMMENT '视频总时长，单位秒',
  `started_at` datetime DEFAULT NULL COMMENT '开始学习时间',
  `completed_at` datetime DEFAULT NULL COMMENT '完成时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_course_resource` (`user_id`,`course_id`,`course_point_id`,`resource_type`,`resource_id`),
  KEY `idx_user_course` (`user_id`,`course_id`),
  KEY `idx_course_point` (`course_point_id`),
  KEY `idx_resource` (`resource_type`,`resource_id`),
  KEY `idx_course_status` (`course_id`,`status`),
  CONSTRAINT `fk_ucrp_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `fk_ucrp_point` FOREIGN KEY (`course_point_id`) REFERENCES `course_point` (`id`),
  CONSTRAINT `fk_ucrp_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学员课件学习进度表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `user_learning_record`
--
...
CREATE TABLE `user_learning_record` (
  ...
  `user_id` bigint NOT NULL COMMENT '学员ID',
  `course_id` bigint NOT NULL COMMENT '课程ID',
  `course_point_id` bigint DEFAULT NULL COMMENT '课程点ID，可为空',
  `resource_type` tinyint DEFAULT NULL COMMENT '课件类型：1-文章，2-视频，3-PPT，可为空',
  `resource_id` bigint DEFAULT NULL COMMENT '课件ID，可为空',
  `action_type` tinyint NOT NULL COMMENT '行为类型：1-开始课程，2-继续学习，3-完成课件，4-完成课程点，5-完成课程，6-复习课程',
  `title` varchar(200) NOT NULL COMMENT '记录标题',
  `description` varchar(500) DEFAULT NULL COMMENT '记录描述',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录时间',
  PRIMARY KEY (`id`),
  KEY `idx_user_created_at` (`user_id`,`created_at`),
  KEY `idx_user_course` (`user_id`,`course_id`),
  KEY `idx_course_id` (`course_id`),
  KEY `idx_course_point_id` (`course_point_id`),
  KEY `idx_resource` (`resource_type`,`resource_id`),
  CONSTRAINT `fk_learning_record_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
  CONSTRAINT `fk_learning_record_point` FOREIGN KEY (`course_point_id`) REFERENCES `course_point` (`id`),
  CONSTRAINT `fk_learning_record_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
-- Dump completed on 2026-07-11 17:11:55
